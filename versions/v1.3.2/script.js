...
function onOpenCvReady() {
    ...
    logInfoThrottled('OpenCV ready v1.3.2 (basis 1.3.1)');
}
...
function processFrame() {
    ...
    if (performanceStats.frameCount % 60 === 0) {
        ...
        if ((performanceStats.frameCount / 60) % 2 === 0) {
            logInfoThrottled(`HEARTBEAT v1.3.2 frames=${performanceStats.frameCount} avgMs=${performanceStats.avgFrameTime.toFixed(1)} fps=${fps.toFixed(1)}`);
        }
